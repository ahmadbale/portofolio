    ...
    <section className="max-w-[1280px] mx-auto px-5 md:px-16 py-20 md:py-32 flex flex-col md:flex-row items-center gap-12">
      ...
      >
        ...
        <p className="font-[family-name:var(--font-hanken-grotesk)] text-lg leading-relaxed text-on-surface-variant max-w-2xl">
          Tertarik pada bidang IT Developer, Web Developer, Full Stack Developer, UI/UX Designer &amp; Quality Assurance. Fokus pada pengembangan web dan Desain Berpusat pada Pengguna.
        </p>
        ...
        <div className="pt-4">
          <p className="font-[family-name:var(--font-jetbrains-mono)] text-xs uppercase tracking-widest text-on-surface-variant mb-3">
            Temukan saya
          </p>
          <div className="flex gap-4">
            <a
              href="https://github.com/ahmadbale"
              target="_blank"
              rel="noopener noreferrer"
              className="w-10 h-10 rounded-full border border-[var(--card-border)] flex items-center justify-center text-on-surface-variant hover:text-primary hover:border-primary transition-colors"
            >
            ...
            <a
              href="https://www.linkedin.com/in/ahmadbalee/"
              target="_blank"
              rel="noopener noreferrer"
              className="w-10 h-10 rounded-full border border-[var(--card-border)] flex items-center justify-center text-on-surface-variant hover:text-primary hover:border-primary transition-colors"
            >
            ...
            <a
              href="https://instagram.com/iqbal.firmn"
              target="_blank"
              rel="noopener noreferrer"
              className="w-10 h-10 rounded-full border border-[var(--card-border)] flex items-center justify-center text-on-surface-variant hover:text-primary hover:border-primary transition-colors"
            >
            ...
            <a
              href="https://wa.me/6285808741949"
              target="_blank"
              rel="noopener noreferrer"
              className="w-10 h-10 rounded-full border border-[var(--card-border)] flex items-center justify-center text-on-surface-variant hover:text-primary hover:border-primary transition-colors"
            >
            ...
            <a
              href="mailto:ahmadiqbalfirmn@gmail.com"
              className="w-10 h-10 rounded-full border border-[var(--card-border)] flex items-center justify-center text-on-surface-variant hover:text-primary hover:border-primary transition-colors"
            >
